...
module GemOf
  ...
  # @api public
  # @example
  #   gem "beaker", GemOf.location_for(ENV["BEAKER_VERSION"] || "~> 1")
  ...
  def gems
    ...
    <<-HEREDOC
      ...
      group :system_tests do
        gem "beaker",        GemOf.location_for(ENV["BEAKER_VERSION"] ||
          "#{@beaker_version}")
  ...
  #   FIXME: but this in a producer class so it can be actually private
  # @api public
  ...
  module_function :set_gem_versions
end
